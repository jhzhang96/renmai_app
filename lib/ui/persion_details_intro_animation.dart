...
class PersionDetailsIntroAnimation{
  PersionDetailsIntroAnimation(this.controller)
      ...
      curve: new Interval(0.000, 0.500,
        ...
        aboutOpacity = new Tween(begin: 0.0,end: 0.85)
            ...
            curve: Curves.easeIn))),
        persionScrollerXTranslation = new Tween(begin: 6.0,end:0.0 )
            .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.830, 1.000,
            curve: Curves.ease))),
        persionScrollerOpacity = new Tween(begin:0.0 ,end:1.0 )
            .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.830, 1.000,
  ...
  final Animation<double> persionScrollerXTranslation;
  final Animation<double> persionScrollerOpacity;
}